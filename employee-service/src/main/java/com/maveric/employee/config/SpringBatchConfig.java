...
public class SpringBatchConfig {
    ...
    private LineMapper<Employee> lineMapper() {
        ...
        lineTokenizer.setNames("id", "firstName", "middleName", "lastName", "address", "phoneNumber", "email");
    ...
    @Bean
    public Step step1() {
        return this.stepBuilderFactory.get("csv-step").<Employee, Employee>chunk(5).reader(reader()).processor(processor()).writer(writer()).taskExecutor(taskExecutor()).build();
    }
