package com.maveric.employee.aop;
...
public class EmployeeAspect {
    private final Logger log = LoggerFactory.getLogger(EmployeeAspect.class);

    @Before(value = "execution(* com.maveric.employee.controller.*.*(..))")
    public void logStatementBefore(JoinPoint joinPoint) {
        log.info("Executing controller {}", joinPoint);
    }

    @Before(value = "execution(* com.maveric.employee.service.*.*(..))")
    public void logStatementBeforeService(JoinPoint joinpoint) {
        log.info("Executing Service {}", joinpoint);
    }

    @After(value = "execution(* com.maveric.employee.controller.*.*(..))")
    public void logStatementAfter(JoinPoint joinPoint) {
        log.info("Complete execution of controller {}", joinPoint);
    }

    @AfterReturning(value = "execution(* com.maveric.employee.controller.*.*(..))", returning = "result")
